...
class BatterStats(Base):
    ...
    team_id: Mapped[int] = mapped_column(ForeignKey("teams.team_id"))
    pa: Mapped[int | None]
    ba: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    obp: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    slg: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    ops: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    xba: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    xslg: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    xwoba: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    woba: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    ...
    barrel_rate: Mapped[Decimal | None] = mapped_column(Numeric(5, 3))
    hard_hit_rate: Mapped[Decimal | None] = mapped_column(Numeric(5, 3))
...
class PitcherStats(Base):
    ...
    whip: Mapped[Decimal | None] = mapped_column(Numeric(4, 2))
    fip: Mapped[Decimal | None] = mapped_column(Numeric(4, 2))
    k_9: Mapped[Decimal | None] = mapped_column(Numeric(4, 2))
    bb_9: Mapped[Decimal | None] = mapped_column(Numeric(4, 2))
    xera: Mapped[Decimal | None] = mapped_column(Numeric(4, 2))
    xwoba_against: Mapped[Decimal | None] = mapped_column(Numeric(4, 3))
    hard_hit_rate_against: Mapped[Decimal | None] = mapped_column(Numeric(5, 3))
    barrel_rate_against: Mapped[Decimal | None] = mapped_column(Numeric(5, 3))
